...
const CAMERAS_SUMMARY =
  'Cutting-Edge Cameras. Picture your best photos and videos. ' +
  'Stunning made simple: advanced cameras and Center Stage. ' +
  "Keep on zoomin': focal lengths, framing flexibility, 8x optical-quality zoom on iPhone 17 Pro. " +
  'Make movies like the movies: 4K, Dolby Vision, Action mode, Camera Control.'

export default function GetToKnowCamerasModal({ open, onClose, exactModel = '' }) {
  const titleId = useId()
    ...
    <AnimatePresence>
      {open ? (
        ...
        >
          ...
          >
            <p className="sr-only">{CAMERAS_SUMMARY}</p>
            ...
            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain bg-white px-3 pb-6 pt-2 md:px-6 md:pb-8 md:pt-3">
              <img
                src="/iphone-models/get-to-know-cameras-full.png"
                alt=""
